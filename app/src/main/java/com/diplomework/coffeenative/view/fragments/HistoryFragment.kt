...
class HistoryFragment(private val callback: IDataUpdatedCallback) : Fragment() {
    ...
    companion object {
        fun newInstance(callback: IDataUpdatedCallback) = HistoryFragment(callback)
    }
